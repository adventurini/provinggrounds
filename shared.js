    ...
    navEl.innerHTML = `
      <div class="nav-inner">
        <a href="index.html" class="nav-logo">
          <img src="images/logo-nav.png" width="480" height="320" alt="Proving Grounds Fight Club" decoding="async">
        </a>
      ...
      <div class="footer-inner">
        <div class="footer-grid">
          <div class="footer-brand">
            <a href="index.html" class="footer-logo"><img src="images/logo-footer.png" width="432" height="288" alt="Proving Grounds Fight Club" decoding="async"></a>
